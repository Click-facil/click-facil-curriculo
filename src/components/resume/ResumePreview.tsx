...
const ModernTemplate = ({ data }: { data: ResumeData }) => {
  ...
  return (
    <div
      ...
      style={{ fontFamily: "'Inter', sans-serif", fontSize: "12px", lineHeight: "1.6", minHeight: "297mm", letterSpacing: "0.01em", textRendering: "optimizeLegibility", WebkitFontSmoothing: "antialiased" }}
    >
      {/* Header */}
        ...
        <div className="w-[32%] flex items-center justify-center py-6 px-4">
          {personalInfo.photo ? (
            <img
              ...
              alt="Foto 3x4"
              className="w-24 h-32 rounded-md object-fill border-2 shadow-md ring-1 ring-black/10 flex-shrink-0"
...
const ClassicTemplate = ({ data }: { data: ResumeData }) => {
  ...
  return (
    <div
      id="resume-preview"
      className="bg-white w-full max-w-[210mm] mx-auto shadow-elevated"
      style={{ fontFamily: "'Georgia', 'Times New Roman', serif", fontSize: "12px", lineHeight: "1.65", minHeight: "297mm", letterSpacing: "0.01em", textRendering: "optimizeLegibility", WebkitFontSmoothing: "antialiased" }}
    >
      {/* Header - centered, traditional */}
      <div className="text-center pt-10 pb-5 px-10" style={{ borderBottom: `3px double ${primary}` }}>
        {personalInfo.photo && (
          <img src={personalInfo.photo} alt="Foto 3x4" className="w-24 h-32 rounded-md object-fill mx-auto mb-3 border-2 shadow-md ring-1 ring-black/10" style={{ borderColor: primary }} />
        )}
    ...
    >
      ...
      <div className="px-10 pt-10 pb-5" style={{ borderBottom: "2px solid #222" }}>
        <div className="flex items-center gap-6">
          {personalInfo.photo && (
            <img src={personalInfo.photo} alt="Foto 3x4" className="w-24 h-32 rounded-md object-fill shadow-sm ring-1 ring-black/10 flex-shrink-0" />
          )}
          <div>
  ...
  return (
    ...
    >
      ...
      <div className="px-10 pt-8 pb-6 flex items-center gap-6" style={{ backgroundColor: bg }}>
        {personalInfo.photo ? (
          <img src={personalInfo.photo} alt="Foto" className="w-24 h-32 rounded-lg object-fill shadow-md flex-shrink-0" style={{ border: `3px solid ${accent}` }} />
        ) : (
  ...
  return (
    ...
    >
      ...
      <div className="px-10 pt-10 pb-6 flex items-center gap-6" style={{ backgroundColor: dark, color: "white" }}>
        {personalInfo.photo ? (
          <img src={personalInfo.photo} alt="Foto" className="w-24 h-32 rounded object-fill shadow-md flex-shrink-0" style={{ border: `2px solid ${gold}` }} />
        ) : (
